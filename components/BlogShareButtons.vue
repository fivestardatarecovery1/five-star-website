...
function openShare(href: string) {
  window.open(href, 'share-dialog', 'width=600,height=480,left=200,top=100,resizable=yes,scrollbars=yes')
}
...
<template>
  <div class="blog-share">
    ...
    <div class="share-buttons">
      <button
        @click="openShare(`https://www.linkedin.com/sharing/share-offsite/?url=${encodedUrl}`)"
      ...
      <button
        @click="openShare(`https://twitter.com/intent/tweet?url=${encodedUrl}&text=${encodedTitle}`)"
      ...
      <button
        @click="openShare(`https://www.facebook.com/sharer/sharer.php?u=${encodedUrl}`)"
