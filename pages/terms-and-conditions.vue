      ...
      "@graph": [
        {
          ...
          "url": "https://www.fivestardatarecovery.com/terms-and-conditions/",
          "description": "Read the official Terms and Conditions for using Five Star Data Recovery's website and services. Review our policies regarding data recovery procedures, limitations, and customer responsibilities.",
          "publisher": {
            "@type": "Organization",
          ...
          "breadcrumb": {
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 2, "name": "Terms and Conditions", "item": "https://www.fivestardatarecovery.com/terms-and-conditions/" }
            ]
          }
        },
        {
...
<template>
  <div class="page-content">
    ...
    <HeroSection
      ...
      description="At Five Star Data Recovery, we value transparency and want every customer to fully understand our process. Our Terms and Conditions outline important details about our services, including pricing, turnaround times, liability limitations, and how recovered data is handled."
      bgImage="/terms-and-conditions-hero.jpg"
      :showForm="false"
      :showButtons="false"
    ...
    <section class="s-white">
      <div class="container pp-wrap">
        <p class="pp-updated">Last Updated: May 2025</p>
        ...
        <div class="pp-section">
          <h2>1. Authorization and Consent</h2>
          ...
          <h3>1A. Terms &amp; Conditions Specifically For Data Recovery Services:</h3>
          <p>Regarding the recovery of data from Customer's damaged hard drive(s)/device(s):</p>
          <ul>
            <li>A. Customer authorizes Five Star Data Recovery to perform all necessary work on Customer's hard drive(s)/device(s).</li>
            <li>B. Customer agrees that Five Star Data Recovery is not responsible for any damage resulting from servicing Customer's hard drive(s)/device(s).</li>
            <li>C. Customer agrees that Five Star Data Recovery may need to open Customer's hard drive(s)/device(s) for diagnosis or repair and that Customer's warranty may be voided.</li>
            <li>D. Customer agrees that if Five Star Data Recovery recovers 99.9% or more of Customer's data from a hard drive/device, Customer will pay previously agreed upon rate for the recovered data from each hard drive together with all state and local taxes.</li>
            <li>E. Customer agrees that if Five Star Data Recovery recovers 0% of Customer's data from a hard drive/device, Customer owes nothing (excluding return shipping costs, if applicable).</li>
            <li>F. Customer agrees that if Company recovers Customer's data, Company will retain a backup of the data for no more than 14 days after the recovery is finished.</li>
          </ul>
          <p>Once Five Star Data Recovery has completed its initial evaluation and identified the scope of work necessary to complete the data recovery services; Five Star Data Recovery will contact Client for consent to proceed. Five Star Data Recovery will provide Client with a list of recoverable files ("Recovery list") and an estimate for completion of the Services. Upon approval of the Recovery list, Client shall complete a Credit Card Authorization Form Authorizing Five Star Data Recovery to complete the Services and charge Client's credit card for the Services.</p>
        </div>

        <div class="pp-section">
          <h2>2. Data Confidentiality</h2>
