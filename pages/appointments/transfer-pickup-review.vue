...
.fl-note { font-size: 0.72rem; font-weight: 400; color: #6b7280; text-transform: none; letter-spacing: 0; }
.req { color: #ef4444; }
.fi {
...
.review-lbl { font-size: 12px; font-weight: 700; color: #64748b; text-transform: uppercase; letter-spacing: 0.5px; flex-shrink: 0; }
