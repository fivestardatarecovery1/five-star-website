...
useSeoMeta({
  ...
  description: 'Professional video file repair for corrupted, damaged, or unplayable video footage. All camera formats supported. Call 323-672-3000.'
})
const faqs = [
...
<template>
  <div>
    <NavBar />
    <HeroSection title="Video File Repair" subtitle="Corrupted Footage? We Repair and Recover Your Video Files." description="Corrupted, damaged, or unplayable video footage is a nightmare for filmmakers, photographers, and videographers. We specialize in video file repair and recovery from all camera formats.">
      <template #badges>
        <div class="trust-badges">
          <span class="badge">✅ All Camera Formats</span>
          <span class="badge">✅ Corrupted Footage</span>
    ...
    <section class="intro-section">
      <div class="container">
        <div class="section-header"><h2 class="section-title">Video File <span class="gold-underline gold">Recovery Service</span></h2></div>
        <div class="intro-content">
          <p>Corrupted video files are one of the most heartbreaking forms of data loss for creative professionals. Wedding footage, commercial shoots, documentary footage, family videos — when these files become unplayable, the lost content is often irreplaceable.</p>
          <p>We repair and recover video files from all camera brands and formats including Sony, Canon, Nikon, Panasonic, GoPro, DJI, RED, ARRI, and consumer cameras. We handle corrupted MOV, MP4, MXF, AVCHD, and RAW video formats from SD cards, CFast cards, USB drives, and hard drives.</p>
