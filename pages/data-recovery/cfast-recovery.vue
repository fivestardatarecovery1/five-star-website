...
const issues = [
  { icon: '🗑️', title: 'Accidental file deletion', text: '' },
  { icon: '🗑️', title: 'Formatted or reformatted CFast cards', text: '' },
  { icon: '⚙️', title: 'Corrupted file systems', text: '' },
  { icon: '🔍', title: 'Card not recognized by camera or computer', text: '' },
]
...
const d3Texts = [
  'CFast Card Data Recovery devices can fail due to a variety of causes including physical damage, firmware corruption, electrical issues, and normal wear over time.',
...
const midBody = [
  'Whether you’re dealing with a corrupt CFast card, accidental deletion, or damaged media files, we’re here to help.',
  'We offer free diagnostics, transparent pricing, and fast results. Our team has extensive experience recovering data from high-end cameras and production media, making us the trusted choice for professionals.',
  'Don’t risk your files with generic software tools. Trust the experts in CFast card data recovery who understand the urgency and sensitivity of your work.',
]

const contactText = 'Whether you’re dealing with a corrupt CFast card, accidental deletion, or damaged media files, we’re here to help.'
const contactList = [
  'Visit our lab in Glendale, CA',
  'Mail your drive to us from anywhere in the U.S.',
  'Call us today for a free evaluation',
]
const contactOutro = 'Trust our experts for fast, secure, and professional cfast card data recovery — and get back what matters most.'

const reviews = [
  { 'text': 'My CFast card suddenly became unreadable right in the middle of a film shoot. I brought it in for evaluation and was relieved when they said recovery was possible. Within days, I had all my RAW footage back. Quick, professional, and highly recommended for anyone dealing with CFast card failure.', 'name': 'David R.', 'location': 'Glendale, CA' },
  { 'text': 'My CFast card was showing errors and wouldn’t mount on any device. The staff was friendly and explained how CFast recovery works, especially with large video files. They successfully recovered all my footage without any loss. I’ll definitely use them again if I ever have another issue.', 'name': 'Angela T.', 'location': 'Burbank, CA' },
  { 'text': 'I made the mistake of running First Aid on my CFast card after it started acting up, and all my video files completely disappeared. I thought I had made things worse, but Vahan was still able to recover and repair all my missing footage. They explained why using First Aid can actually damage file structures on failing media.', 'name': 'David N.', 'location': 'New York, NY' },
]
const faqs = [
]
...
<template>
  <div class="page-content">
    ...
    <HeroSection
      title="CFast Card Data Recovery"
      subtitle="Get Your Data Back In No Time."
      description="We’ve recovered data for video editors, producers, directors, and digital imaging technicians across Hollywood and beyond. Our clients include production studios, ad agencies, wedding videographers, and independent filmmakers. We understand that losing raw footage or production files can delay deadlines and cost thousands. That’s why our  are designed with media professionals in mind — fast, secure, and confidential."
      bgImage="/cfast-card-data-recovery-service-glendale-ca.jpg"
    />
    ...
    <section class="s-white">
      <div class="container">
        ...
        <h2 class="s-heading">Common CFast Card Data Recovery Issues</h2>
        <p  class="s-intro"></p>
    ...
    <section class="s-grey">
      <div class="container asym-layout">
        <div class="asym-minor">
          ...
          <h2 class="s-heading">What Causes CFast Card Data Recovery Failures?</h2>
        ...
        <div class="asym-major">
          <img src="/cfast-card-data-recovery-service-glendale-ca.jpg" alt="CFast Card Data Recovery service Glendale CA" class="rounded-img" />
    ...
    <section class="s-grey">
      <div class="container dual-col">
        <div class="dual-box">
          ...
          <h3 class="dual-heading">Why CFast Card Data Recovery Devices Are Prone to Issues</h3>
    ...
    <!-- MID-PAGE FORM -->
    <section class="mid-form-section" style="background: linear-gradient(to right, rgba(50,52,58,0.92) 0%, rgba(50,52,58,0.72) 50%, rgba(30,32,38,0.2) 100%), url('/cfast-card-data-recovery-service-glendale-ca.jpg') right center / cover no-repeat;">
      <div class="container mid-form-inner">
        <div class="mid-form-text">
          <div class="section-label light">Get Started</div>
          <h2 class="dark-heading">Need Help With Your CFast Card Data Recovery?</h2>
            ...
            <div class="mf-row">
              ...
              <div class="mf-group">
                ...
                <div class="mf-radio-group">
                  <label class="mf-radio"><input type="radio" name="contactCFastCa" value="call" checked /> CALL</label>
                  <label class="mf-radio"><input type="radio" name="contactCFastCa" value="email" /> EMAIL</label>
                  <label class="mf-radio"><input type="radio" name="contactCFastCa" value="text" /> TEXT</label>
                </div>
              </div>
            </div>
    ...
    <section class="s-contact-band">
      <div class="container">
        <div class="contact-banner-card">
          <h2 class="contact-banner-heading">Contact Us for CFast Card Data Recovery</h2>
        </div>
