...
useSeoMeta({
  ...
  description: 'Hard drive not showing up or detected? Five Star Data Recovery diagnoses and recovers data from undetected drives.'
})
...
const reviews = [
  { name: 'Brian K.', location: 'Los Angeles, CA', stars: 5, text: 'My external hard drive suddenly stopped showing up on my computer, and I couldn’t access any of my files. I contacted Five Star Data Recovery and spoke with Elen, who explained the process clearly and helped me get the drive checked in. Within a few days, they recovered all of my photos and business documents. Their service was fast, professional, and affordable.' },
  { name: '99%', location: 'of my files. Their flat-rate pricing and No Data, No Charge policy gave me peace of mind. I’m so glad I found them!"', stars: 5, text: 'My hard drive wasn’t showing up in Disk Management, and I thought my data was gone for good. Five Star Data Recovery was able to diagnose the problem and recover' },
  { name: 'Henry T', location: 'Summerlin, NV', stars: 5, text: 'I had a Seagate external hard drive that just stopped appearing on my Mac. Vahan personally reviewed my case and explained that the issue was with the drive’s internal firmware. They recovered everything within a week. The communication and updates were top-notch.' },
]
  ...
  <div class="page-wrapper">
    ...
    <section class="hero-section">
      <div class="container hero-inner">
        <div class="hero-text">
          <h1 class="hero-title">Hard Drive Not Showing Up?</h1>
          <p class="hero-sub">Get Your Data Back In No Time.</p>
          <p class="hero-desc">A hard drive that suddenly disappears from your computer is frustrating — and scary if you think you\'ve lost your data. Whether it\'s not showing in Windows Disk Management, not detected by BIOS, or not mounting on your Mac, we can help.</p>
    ...
    <section class="light-alt-section">
      <div class="container">
        <h2 class="section-heading">Why Your Hard Drive Isn’t Showing Up</h2>
        <p class="body-text">Several reasons exist why a hard drive might not appear on your computer. Sometimes it\'s a minor connection issue. Other times, it could point to physical damage or corruption inside the drive. Understanding what might be happening helps you know what to try—and what to leave alone.Common causes include:</p>
        <p class="body-text">Whether it’s a desktop drive, portable external disk, or flash drive, the symptoms are similar. It powers on—or maybe it doesn’t—but your system can’t detect it.</p>
        <ul class="cause-list">
    ...
    <section class="light-section">
      <div class="container">
        <h2 class="section-heading">Windows and macOS: Same Problem, Different Fixes</h2>
        <p class="body-text">If your hard drive is not showing up on Mac, start by opening Disk Utility. The drive may appear there but not mount properly. Sometimes the mac not recognizing the drive in Finder doesn’t mean it’s completely gone.</p>
        <p class="body-text">On Windows, open Device Manager and look under disk drives. You can also check System Information and Disk Management. If your Windows device doesn’t list the drive anywhere, it’s likely a hardware failure or file system issue.</p>
      </div>
    </section>

    <section class="light-alt-section">
      <div class="container">
        <h2 class="section-heading">Safe Troubleshooting You Can Try</h2>
        <p class="body-text">You can rule out simple problems with a few safe checks:</p>
      </div>
    </section>

    <section class="light-section">
      <div class="container">
        <h2 class="section-heading">1. Check the cables and ports</h2>
        <p class="body-text">Try a new USB cable and a different USB port. Cables fail more often than you might expect.</p>
      </div>
    </section>

    <section class="light-alt-section">
      <div class="container">
        <h2 class="section-heading">2. Try a different computer</h2>
        <p class="body-text">See if the drive shows up on another system to rule out device-specific issues.</p>
      </div>
    </section>

    <section class="light-section">
      <div class="container">
        <h2 class="section-heading">3. Restart and check settings</h2>
        <p class="body-text">A reboot can reset system detection. Also, open your system settings to ensure the drive hasn’t been disabled.</p>
      </div>
    </section>

    <section class="light-alt-section">
      <div class="container">
        <h2 class="section-heading">4. Look in system tools</h2>
        <p class="body-text">If your drive is there but shows up as “RAW” or unallocated, that indicates file system corruption.</p>
      </div>
    </section>
    ...
    <section class="contact-band">
      <div class="container contact-band-inner">
        <div class="contact-band-text">
          <h2 class="contact-band-title">Contact Us — Hard Drive Not Showing Up</h2>
          <p class="contact-band-sub">If your hard drive is not showing up, don\'t panic. Contact us for a free evaluation.</p>
