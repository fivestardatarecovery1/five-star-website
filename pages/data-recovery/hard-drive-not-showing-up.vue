...
useSeoMeta({
  title: 'Hard Drive Not Showing Up? Recovery Help | Five Star Data Recovery',
  description: 'Hard drive not recognized or not showing up in Windows or Mac? We diagnose and recover. All failure causes addressed. Call 323-672-3000.'
})
const faqs = [
...
<template>
  <div>
    <NavBar />
    <HeroSection title="Hard Drive Not Showing Up" subtitle="Drive Not Detected? We Find Out Why and Get Your Data." description="When your hard drive stops showing up, it could be a firmware issue, PCB failure, head problem, or something as simple as a connection issue. We diagnose the exact cause and recover your data.">
      <template #badges>
        <div class="trust-badges">
          <span class="badge">✅ All Failure Types</span>
          <span class="badge">✅ Fast Diagnosis</span>
    ...
    <section class="intro-section">
      <div class="container">
        <div class="section-header"><h2 class="section-title">Drive Not Showing Up <span class="gold-underline gold">Recovery Service</span></h2></div>
        <div class="intro-content">
          <p>A hard drive that won't show up in your operating system or BIOS can mean many different things — some simple, some serious. The cause could be a failed PCB (circuit board), corrupted firmware, dead read/write heads, a mechanical failure, or even just a bad cable or loose connection.</p>
          <p>Our engineers use specialized diagnostic hardware to identify the exact cause of your drive's disappearance. We can recover data regardless of why the drive isn't showing up — whether it's a firmware issue we can fix with our tools or a mechanical failure requiring cleanroom work.</p>
