...
useSeoMeta({
  ...
  description: 'Professional external hard drive data recovery for all brands. Free evaluation, flat-rate pricing, no data no charge.'
})
...
const reviews = [
  { name: 'Sarah T.', location: 'Miami, FL', stars: 5, text: 'I thought all my family vacation photos were gone forever after my external hard drive stopped showing up on my computer. I called the team, and within a few days, they had recovered everything for me! The process was stress-free, and they kept me updated the whole time. Highly recommend if you’re facing a similar situation.' },
  { name: 'Jason M.', location: 'Los Angeles, CA', stars: 5, text: 'My 2TB Seagate external drive suddenly started making clicking noises and became completely unreadable. I dropped it off for recovery, and they explained everything clearly from the start. In less than a week, I had all my business files back. The flat-rate pricing gave me peace of mind—no hidden fees or surprises.' },
  { name: 'Sean T.', location: 'Westwood, CA', stars: 5, text: 'I accidentally dropped my Western Digital external hard drive off my desk, and it wouldn’t power on anymore. I was really worried about losing years of photos and documents. Luckily, the engineers here worked their magic. They recovered almost every single file. I’m beyond grateful!' },
]
  ...
  <div class="page-wrapper">
    ...
    <section class="hero-section">
      <div class="container hero-inner">
        <div class="hero-text">
          <h1 class="hero-title">External Hard Drive Data Recovery Services</h1>
          <p class="hero-sub">Get Your Data Back In No Time.</p>
          <p class="hero-desc">No matter if your drive is USB 2.0, 3.0, USB-C, Thunderbolt, or network-attached, we can help recover your data. Five Star Data Recovery offers professional external hard drive data recovery for all brands and failure types.</p>
    ...
    <section class="contact-band">
      <div class="container contact-band-inner">
        <div class="contact-band-text">
          <h2 class="contact-band-title">Contact Us for External Hard Drive Recovery</h2>
          <p class="contact-band-sub">Whether your external drive stopped working, was dropped, or is not showing up, we can help recover your data.</p>
