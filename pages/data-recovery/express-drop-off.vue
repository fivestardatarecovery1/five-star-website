...
const d3Texts = [
  'Express Drop-Off Data Recovery devices can fail due to a variety of causes including physical damage, firmware corruption, electrical issues, and normal wear over time.',
...
const midBody = [
  'The Express Drop-Off Form is a fast and efficient way to start your data recovery case before you arrive. It helps us gather key information in advance so we can begin processing your device as soon as it’s received—minimizing wait times and streamlining the intake process.',
  'Completing the data recovery drop-off form before your visit speeds up check-in and ensures a smooth handoff. It allows our team to prepare for your device’s arrival and start the diagnostic process more efficiently.',
  'While not required, using the Express Drop-Off Form is highly recommended. It’s designed purely for your convenience, allowing you to skip the wait and complete your drop-off in just a few minutes. A quick and simple way to get your device in without any delays.',
]

const contactText = 'If you\'re experiencing issues with your Express Drop-Off Data Recovery, don\'t wait. Acting early gives you the best chance of recovering your data safely and completely.'
const contactList = [
  'Visit our lab in Glendale, CA',
  'Mail your drive to us from anywhere in the U.S.',
  'Call us today for a free evaluation',
]
const contactOutro = 'Trust our experts for fast, secure, and professional express drop-off data recovery — and get back what matters most.'
  ...
  <div class="page-content">
    ...
    <section class="s-white">
      <div class="container">
        ...
        <h2 class="s-heading">Common Express Drop-Off Data Recovery Issues</h2>
        <p  class="s-intro"></p>
    ...
    <section class="s-grey">
      <div class="container asym-layout">
        <div class="asym-minor">
          ...
          <h2 class="s-heading">What Causes Express Drop-Off Data Recovery Failures?</h2>
        ...
        <div class="asym-major">
          <img src="/express-drop-off-data-recovery-glendale-ca.jpg" alt="Express Drop-Off Data Recovery service Glendale CA" class="rounded-img" />
    ...
    <section class="s-grey">
      <div class="container dual-col">
        <div class="dual-box">
          ...
          <h3 class="dual-heading">Why Express Drop-Off Data Recovery Devices Are Prone to Issues</h3>
    ...
    <!-- MID-PAGE FORM -->
    <section class="mid-form-section" style="background: linear-gradient(to right, rgba(50,52,58,0.92) 0%, rgba(50,52,58,0.72) 50%, rgba(30,32,38,0.2) 100%), url('/express-drop-off-data-recovery-glendale-ca.jpg') right center / cover no-repeat;">
      <div class="container mid-form-inner">
        <div class="mid-form-text">
          <div class="section-label light">Get Started</div>
          <h2 class="dark-heading">Need Help With Your Express Drop-Off Data Recovery?</h2>
            ...
            <div class="mf-row">
              ...
              <div class="mf-group">
                ...
                <div class="mf-radio-group">
                  <label class="mf-radio"><input type="radio" name="contactExpress" value="call" checked /> CALL</label>
                  <label class="mf-radio"><input type="radio" name="contactExpress" value="email" /> EMAIL</label>
                  <label class="mf-radio"><input type="radio" name="contactExpress" value="text" /> TEXT</label>
                </div>
              </div>
            </div>
    ...
    <section class="s-contact-band">
      <div class="container">
        <div class="contact-banner-card">
          <h2 class="contact-banner-heading">Contact Us for Express Drop-Off Data Recovery</h2>
        </div>
