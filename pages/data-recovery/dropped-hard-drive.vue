...
useSeoMeta({
  ...
  description: 'Dropped your hard drive? Five Star Data Recovery specializes in physical impact recovery. Free evaluation.'
})
  ...
  <div class="page-wrapper">
    ...
    <section class="hero-section">
      <div class="container hero-inner">
        <div class="hero-text">
          <h1 class="hero-title">Dropped Hard Drive Data Recovery</h1>
          <p class="hero-sub">Get Your Data Back In No Time.</p>
          <p class="hero-desc">Dropping a hard drive is one of the most common causes of physical damage. Even a short fall can cause read/write head damage, platter scratches, or spindle misalignment. Our cleanroom engineers can safely recover your data.</p>
    ...
    <section class="contact-band">
      <div class="container contact-band-inner">
        <div class="contact-band-text">
          <h2 class="contact-band-title">Contact Us — Dropped Hard Drive Recovery</h2>
          <p class="contact-band-sub">Physical impact can damage a hard drive internally. Contact us immediately for a free evaluation before attempting any repairs.</p>
