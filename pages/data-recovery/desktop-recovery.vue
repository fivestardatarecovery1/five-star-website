...
useSeoMeta({
  ...
  description: 'Desktop data recovery from Windows, Linux, and custom-built PCs. All desktop drive types recovered. No data = no charge. Call 323-672-3000.'
})
const faqs = [
...
<template>
  <div>
    <NavBar />
    <HeroSection title="Desktop Computer Recovery" subtitle="Internal Drive Failure? We Get Your Files Back." description="Desktop computers store years of valuable data — documents, photos, business files, and more. When the internal drive fails, our engineers recover everything using proven methods.">
      <template #badges>
        <div class="trust-badges">
          <span class="badge">✅ Windows & Linux</span>
          <span class="badge">✅ All Drive Types</span>
    ...
    <section class="intro-section">
      <div class="container">
        <div class="section-header"><h2 class="section-title">Desktop <span class="gold-underline gold">Recovery Service</span></h2></div>
        <div class="intro-content">
          <p>Desktop computers are the workhorses of homes and offices. They hold tax records, business databases, creative projects, and personal memories. When the internal drive fails — whether from age, failure, or accident — the data can seem gone forever.</p>
          <p>We recover from all desktop drive types — 3.5 HDDs, 2.5 drives in desktop enclosures, SSDs, and NVMe drives in Windows, Linux, and custom-built systems. We handle everything from logical failures and corrupted file systems to physical drive damage.</p>
