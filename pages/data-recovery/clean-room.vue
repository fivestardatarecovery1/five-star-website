...
useSeoMeta({
  title: 'Clean Room Data Recovery — ISO Class 5 Facility | Five Star Data Recovery',
  description: 'ISO Class 5 cleanroom data recovery for physically damaged hard drives. Head replacements, platter transfers, PCB repairs. Call 323-672-3000.'
})
const faqs = [
...
<template>
  <div>
    <NavBar />
    <HeroSection title="Clean Room Data Recovery" subtitle="State-of-the-Art ISO Class 5 Cleanroom Facility." description="When a hard drive suffers physical damage, it must be opened and repaired in a dust-free cleanroom environment. Our ISO Class 5 cleanroom was purpose-built for exactly this — protecting your data while we perform precision surgery on your drive.">
      <template #badges>
        <div class="trust-badges">
          <span class="badge">✅ ISO Class 5 Cleanroom</span>
          <span class="badge">✅ Head Replacement Experts</span>
    ...
    <section class="intro-section">
      <div class="container">
        <div class="section-header"><h2 class="section-title">Clean Room <span class="gold-underline gold">Recovery Service</span></h2></div>
        <div class="intro-content">
          <p>A cleanroom is a specially controlled environment where airborne particles are filtered to protect sensitive electronic components. Hard drives are manufactured in cleanrooms because even a single dust particle can cause catastrophic damage to the platters and read/write heads.</p>
          <p>Our cleanroom meets ISO Class 5 standards (equivalent to Class 100 cleanroom) — containing fewer than 100 particles per cubic foot. We perform head replacements, platter transfers, PCB repairs, and motor replacements in this controlled environment. Every technician wears full protective gear and follows strict protocols.</p>
