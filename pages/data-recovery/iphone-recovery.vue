...
const causes = [
  ...
  'iPhones stuck in boot loop or Apple logo',
  'Burned logic boards',
  'Broken NAND or baseband components',
...
const d3Texts = [
  'iPhone Data Recovery devices can fail due to a variety of causes including physical damage, firmware corruption, electrical issues, and normal wear over time.',
...
const midBody = [
  ...
  'Yes, we specialize in iPhone data recovery from devices stuck in a boot loop or frozen on the Apple logo. These issues are often caused by system corruption or hardware failure. Our engineers perform board-level diagnostics to restore temporary functionality and extract your important files safely.',
]

const contactText = 'If you\'re experiencing issues with your iPhone Data Recovery, don\'t wait. Acting early gives you the best chance of recovering your data safely and completely.'
const contactList = [
  ...
  <div class="page-content">
    ...
    <section class="s-white">
      <div class="container">
        ...
        <h2 class="s-heading">Common iPhone Data Recovery Issues</h2>
        <p  class="s-intro"></p>
    ...
    <section class="s-grey">
      <div class="container asym-layout">
        <div class="asym-minor">
          ...
          <h2 class="s-heading">What Causes iPhone Data Recovery Failures?</h2>
        ...
        <div class="asym-major">
          <img src="/iphone-data-recovery-service-glendale-ca.webp" alt="iPhone Data Recovery Services service Glendale CA" class="rounded-img" />
    ...
    <section class="s-grey">
      <div class="container dual-col">
        <div class="dual-box">
          ...
          <h3 class="dual-heading">Why iPhone Data Recovery Devices Are Prone to Issues</h3>
    ...
    <!-- MID-PAGE FORM -->
    <section class="mid-form-section" style="background: linear-gradient(to right, rgba(50,52,58,0.92) 0%, rgba(50,52,58,0.72) 50%, rgba(30,32,38,0.2) 100%), url('/iphone-data-recovery-service-glendale-ca.webp') right center / cover no-repeat;">
      <div class="container mid-form-inner">
        <div class="mid-form-text">
          <div class="section-label light">Get Started</div>
          <h2 class="dark-heading">Need Help With Your iPhone Data Recovery?</h2>
            ...
            <div class="mf-row">
              ...
              <div class="mf-group">
                ...
                <div class="mf-radio-group">
                  <label class="mf-radio"><input type="radio" name="contactiPhoneD" value="call" checked /> CALL</label>
                  <label class="mf-radio"><input type="radio" name="contactiPhoneD" value="email" /> EMAIL</label>
                  <label class="mf-radio"><input type="radio" name="contactiPhoneD" value="text" /> TEXT</label>
                </div>
              </div>
            </div>
    ...
    <section class="s-contact-band">
      <div class="container">
        <div class="contact-banner-card">
          <h2 class="contact-banner-heading">Contact Us for iPhone Data Recovery Services</h2>
        </div>
