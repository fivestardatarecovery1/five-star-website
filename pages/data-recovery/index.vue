    ...
    <section class="s-white">
      <div class="container reasons-layout">
        ...
        <div class="reasons-image">
          <NuxtImg src="/common-reasons-data-recovery.jpg" alt="Data recovery technician working on hard drive with blue gloves" class="reasons-img" width="800" height="534" loading="lazy" format="webp" sizes="xs:100vw sm:100vw md:100vw lg:50vw xl:50vw" />
        </div>
      </div>
    </section>
    ...
    <section class="s-white">
      <div class="container asym-layout">
        ...
        <div class="asym-major">
          <NuxtImg src="/hard-drive-recovery-service-los-angeles.webp" alt="Data recovery lab Glendale CA" class="rounded-img" width="2560" height="1152" loading="lazy" format="webp" sizes="xs:100vw sm:100vw md:100vw lg:50vw xl:50vw" />
