      ...
      innerHTML: JSON.stringify({
        ...
        "@graph": [
          ...
          },
          {
            "@type": "FAQPage",
            "mainEntity": [
              { "@type": "Question", "name": "What are common causes of USB drive failure?", "acceptedAnswer": { "@type": "Answer", "text": "USB drives can fail due to physical damage (e.g., broken connectors), file system corruption, water exposure, electrical surges, firmware issues, or improper removal during file transfers. Even simple wear and tear can cause data loss over time." } },
              { "@type": "Question", "name": "Can you recover data from a physically damaged USB drive?", "acceptedAnswer": { "@type": "Answer", "text": "Yes, depending on the type of physical damage. If the USB connector or circuit board is broken, recovery is often still possible through monolith or chip-off recovery. However, if the NAND chip itself is cracked or physically damaged, recovery becomes impossible." } },
              { "@type": "Question", "name": "I accidentally deleted files from my USB drive. Can you get them back?", "acceptedAnswer": { "@type": "Answer", "text": "In many cases, yes. As long as the files haven't been overwritten and TRIM hasn't been activated, the chances of recovery are very high. Stop using the drive immediately and bring it in for evaluation." } }
            ]
          }
        ]
      })
