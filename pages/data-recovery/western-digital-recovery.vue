...
const causes = [
  ...
  'Power surges damaging internal components or the PCB',
...
const driveTypes = [
  ...
  'WD Black, Blue, and Green Series',
  'WD My Book and My Cloud',
  'WD Easystore Drives',
  'Internal SATA, PATA, and IDE models',
...
const troubleshootingTips = [
  ...
  'Open Disk Management in Windows to check if the drive is visible but unallocated',
      ...
      <div class="container mid-form-inner">
        ...
        <div class="mid-form-card">
          ...
          <form @submit.prevent class="mid-consult-form">
            ...
            <div class="mf-row">
              <div class="mf-group">
                <label for="wd-device-type">SELECT YOUR DEVICE TYPE</label>
                <div class="mf-select-wrap">
                  <select id="wd-device-type" class="mf-input">
            ...
            <div class="mf-row">
              <div class="mf-group">
                <label for="wd-device-issue">SELECT ISSUE WITH DEVICE</label>
                <div class="mf-select-wrap">
                  <select id="wd-device-issue" class="mf-input">
            ...
            <div class="mf-group mf-full">
              <label for="wd-response-time">PREFERRED RESPONSE TIME</label>
              <div class="mf-select-wrap">
                <select id="wd-response-time" class="mf-input">
