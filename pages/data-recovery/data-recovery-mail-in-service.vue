...
const mailVideoActive = ref(false)
  ...
  <div class="page-content">
    ...
    <section class="video-section">
      <div class="container video-inner">
        ...
        <div class="video-embed" @click="mailVideoActive = true" style="cursor:pointer;background:#000;">
          <template v-if="!mailVideoActive">
...
.stepper-circle { width: 40px; height: 40px; border-radius: 50%; background: #e8edf4; color: #4a5e7a; font-size: 0.95rem; font-weight: 800; display: flex; align-items: center; justify-content: center; transition: background 0.3s, color 0.3s; border: 3px solid #fff; box-shadow: 0 0 0 2px #e8edf4; }
...
.process-body { font-size: 0.78rem; color: #a0b0c8; line-height: 1.6; margin: 0; }
...
.video-desc { font-size: 0.95rem; color: #a0b0c8; line-height: 1.8; }
...
.yt-play { position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); background: none; border: none; cursor: pointer; padding: 0; opacity: 0.9; transition: opacity 0.2s, transform 0.2s; }
