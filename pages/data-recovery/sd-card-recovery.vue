...
useSeoMeta({
  title: 'SD Card Data Recovery — All Formats | Five Star Data Recovery',
  description: 'Professional SD card recovery for all formats. Camera, drone, GoPro, dashcam. Deleted photos/videos recovered. No data = no charge. Call 323-672-3000.'
})
const faqs = [
...
<template>
  <div>
    <NavBar />
    <HeroSection title="SD Card Data Recovery" subtitle="Lost Photos or Videos? We Recover from Every SD Format." description="Whether it's your camera card with irreplaceable photos, drone footage, GoPro clips, or dashcam video — we recover data from all SD card formats and all failure types.">
      <template #badges>
        <div class="trust-badges">
          <span class="badge">✅ All SD Formats</span>
          <span class="badge">✅ Camera & Drone Media</span>
    ...
    <section class="intro-section">
      <div class="container">
        <div class="section-header"><h2 class="section-title">SD Card <span class="gold-underline gold">Recovery Service</span></h2></div>
        <div class="intro-content">
          <p>Memory cards are used for the most important moments — weddings, vacations, professional shoots. When they fail, the stakes are incredibly high. At Five Star Data Recovery, we treat every SD card recovery with the urgency and care it deserves.</p>
          <p>We recover from SD, SDHC, SDXC, microSD, microSDHC, microSDXC, CompactFlash, and xD cards. We work with all camera brands including Canon, Nikon, Sony, Fuji, Olympus, Panasonic, GoPro, and DJI drone media.</p>
