...
const processIntro = 'We use a systematic, proven approach for every SD Card Data Recovery case.'
const steps = [
...
const driveTypes = [
  'In-house lab with certified engineers',
  'Industry-grade recovery tools for deep-level access',
  'Transparent pricing and honest diagnostics',
  'High recovery success rates—even with severe damage',
  'Local drop-off or nationwide mail-in data recovery options',
...
const d3Texts = [
  'SD Card Data Recovery devices can fail due to a variety of causes including physical damage, firmware corruption, electrical issues, and normal wear over time.',
...
const midBody = [
  'At Five Star Data Recovery, SD card recovery is priced based on the type of failure and the method required to retrieve the data. Here’s a breakdown of our standard pricing:',
  'This applies to SD cards that are physically intact but are no longer recognized properly by your device or computer. Common symptoms include:',
  '“Card needs to be formatted” errors',
]

const contactText = 'If you\'re experiencing issues with your SD Card Data Recovery, don\'t wait. Acting early gives you the best chance of recovering your data safely and completely.'
const contactList = [
  'Visit our lab in Glendale, CA',
  'Mail your drive to us from anywhere in the U.S.',
  'Call us today for a free evaluation',
]
const contactOutro = 'Trust our experts for fast, secure, and professional sd card data recovery — and get back what matters most.'
...
<template>
  <div class="page-content">
    ...
    <HeroSection
      ...
      bgImage="/sd-card-data-recovery-service-glendale-ca.jpg"
    />
    ...
    <section class="s-white">
      <div class="container">
        ...
        <h2 class="s-heading">Common SD Card Data Recovery Issues</h2>
        <p  class="s-intro"></p>
    ...
    <section class="s-grey">
      <div class="container asym-layout">
        <div class="asym-minor">
          ...
          <h2 class="s-heading">What Causes SD Card Data Recovery Failures?</h2>
        ...
        <div class="asym-major">
          <img src="/sd-card-data-recovery-service-glendale-ca.jpg" alt="SD Card Data Recovery service Glendale CA" class="rounded-img" />
    ...
    <section class="s-grey">
      <div class="container dual-col">
        <div class="dual-box">
          ...
          <h3 class="dual-heading">Why SD Card Data Recovery Devices Are Prone to Issues</h3>
    ...
    <!-- MID-PAGE FORM -->
    <section class="mid-form-section" style="background: linear-gradient(to right, rgba(50,52,58,0.92) 0%, rgba(50,52,58,0.72) 50%, rgba(30,32,38,0.2) 100%), url('/sd-card-data-recovery-service-glendale-ca.jpg') right center / cover no-repeat;">
      <div class="container mid-form-inner">
        <div class="mid-form-text">
          <div class="section-label light">Get Started</div>
          <h2 class="dark-heading">Need Help With Your SD Card Data Recovery?</h2>
            ...
            <div class="mf-row">
              ...
              <div class="mf-group">
                ...
                <div class="mf-radio-group">
                  <label class="mf-radio"><input type="radio" name="contactSDCard" value="call" checked /> CALL</label>
                  <label class="mf-radio"><input type="radio" name="contactSDCard" value="email" /> EMAIL</label>
                  <label class="mf-radio"><input type="radio" name="contactSDCard" value="text" /> TEXT</label>
                </div>
              </div>
            </div>
    ...
    <section class="s-contact-band">
      <div class="container">
        <div class="contact-banner-card">
          <h2 class="contact-banner-heading">Contact Us for SD Card Data Recovery</h2>
        </div>
