...
useSeoMeta({
  ...
  description: 'Expedited data recovery in 24-48 hours. Five Star Data Recovery offers fast turnaround for urgent cases.'
})
  ...
  <div class="page-wrapper">
    ...
    <section class="hero-section">
      <div class="container hero-inner">
        <div class="hero-text">
          <h1 class="hero-title">Expedited Data Recovery Service</h1>
          <p class="hero-sub">Get Your Data Back In No Time.</p>
          <p class="hero-desc">When time is critical, our Expedited Data Recovery service guarantees your case is handled immediately. Yes, of course. We understand that some recoveries are time sensitive and need to be completed as soon as possible.</p>
    ...
    <section class="light-section">
      <div class="container">
        <h2 class="section-heading">Do you offer a Priority Data Recovery Service?</h2>
        <p class="body-text">Yes, of course. We understand that some recoveries are time sensitive and need to be completed as soon as possible. We offer an Expedited Service which would put your case at the top of the que. With our Expedited Service, our Engineers will start working on your data recovery case within an hour of drop off, and the case will be handled as a priority within business hours.</p>
        <p class="body-text">With this service, you are guaranteed a diagnosis within 3 hours of the time you drop off your drive. Your case will be worked on non-stop during normal business hours.</p>
      </div>
    </section>
    <section class="light-alt-section">
      <div class="container">
        <h2 class="section-heading">Whats the average turnaround time for Expedited Data Recovery Cases?</h2>
        <p class="body-text">This all really depends on the exact issue with your drive, along with the amount of data. With our Expedited Service, we can guarantee that the entire process will move forward without any delays, but it’s impossible to give an exact turnaround time.</p>
        <p class="body-text">IF the issue with your drive is logical (bad sectors, firmware corruption, damaged file system, etc), and you have less than 2TB of data, we should be able to get the data back to you within 2-3 days.</p>
      </div>
    </section>
    <section class="light-section">
      <div class="container">
    ...
    <section class="contact-band">
      <div class="container contact-band-inner">
        <div class="contact-band-text">
          <h2 class="contact-band-title">Start Your Expedited Recovery Now</h2>
          <p class="contact-band-sub">Expedited recovery in 24-48 hours. Contact us immediately to get started.</p>
