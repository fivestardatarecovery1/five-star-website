      ...
      <div class="container">
        <div class="two-col-layout">
          ...
          <div class="section-img-wrap">
            <NuxtImg src="/expedited-service-technician.jpg" alt="Data recovery technician working on hard drive" class="section-img" width="768" height="512" loading="lazy" format="webp" sizes="xs:100vw sm:100vw md:100vw lg:50vw xl:50vw" />
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="s-grey">
      <div class="container">
        <div class="two-col-layout reverse">
          <div class="section-img-wrap">
            <NuxtImg src="/expedited-service-shipping.jpg" alt="Expedited data recovery mail-in shipping service" class="section-img" width="768" height="512" loading="lazy" format="webp" sizes="xs:100vw sm:100vw md:100vw lg:50vw xl:50vw" />
          </div>
          <div>
    ...
    <section class="s-contact-band">
      <div class="container">
        ...
        <ul class="contact-bullets">
          ...
          <li>Diagnosis guaranteed within 3 hours</li>
          <li>Non-stop work during business hours</li>
          <li>Flat-rate pricing + $200 expedited fee (upfront)</li>
        </ul>
