<template>
  <div class="sitemap-page">
    ...
    <section class="sitemap-hero">
      <div class="container">
        <h1>Site Map</h1>
        <p>A complete directory of every page on Five Star Data Recovery.</p>
      </div>
    </section>
        ...
        <div class="sitemap-grid">
          ...
          <div class="sitemap-group">
            ...
            <ul>
              ...
              <li><NuxtLink to="/data-recovery/bad-sectors">Bad Sectors Recovery</NuxtLink></li>
              <li><NuxtLink to="/drive-doesnt-power-on">Drive Doesn't Power On</NuxtLink></li>
              <li><NuxtLink to="/hard-drive-clicking">Hard Drive Clicking Sound</NuxtLink></li>
            </ul>
          </div>
          ...
          <div class="sitemap-group">
            ...
            <ul>
              <li><NuxtLink to="/blog/usb-data-recovery-chip-off">USB Data Recovery: Chip-Off Method</NuxtLink></li>
              <li><NuxtLink to="/blog/how-to-repair-external-hard-drive-after-it-was-dropped">How to Repair an External Hard Drive After Being Dropped</NuxtLink></li>
            </ul>
          </div>
...
<script setup>
useSeoMeta({
  title: 'Sitemap — Five Star Data Recovery',
  description: 'Browse every page on Five Star Data Recovery — services, locations, pricing, and more.',
  robots: 'index, follow'
})
</script>
