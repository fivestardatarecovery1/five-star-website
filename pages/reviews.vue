...
const reviewsVideoActive = ref(false)
const reviews = [
  {
    name: 'Mikey W.',
  ...
  <div class="page-content">
    ...
    <section class="page-video-section">
      <div class="container page-video-inner">
        ...
        <div class="page-video-embed" @click="reviewsVideoActive = true" style="cursor:pointer;background:#000;">
          <template v-if="!reviewsVideoActive">
