...
const d3Texts = [
  'Terms and Conditions devices can fail due to a variety of causes including physical damage, firmware corruption, electrical issues, and normal wear over time.',
...
const midBody = [
  'At Five Star Data Recovery, we value transparency and want every customer to fully understand our process. Our Terms and Conditions outline important details about our services, including pricing, turnaround times, liability limitations, and how recovered data is handled. We also explain our No Data, No Charge policy, as well as any non-refundable fees that may apply in special case types. By proceeding with our services, you agree to these terms. If you have any questions, our team is happy to help clarify before we begin your recovery.',
]

const contactText = 'If you\'re experiencing issues with your Terms and Conditions, don\'t wait. Acting early gives you the best chance of recovering your data safely and completely.'
const contactList = [
  'Visit our lab in Glendale, CA',
  'Mail your drive to us from anywhere in the U.S.',
  'Call us today for a free evaluation',
]
const contactOutro = 'Trust our experts for fast, secure, and professional terms and conditions — and get back what matters most.'
  ...
  <div class="page-content">
    ...
    <section class="s-white">
      <div class="container">
        ...
        <h2 class="s-heading">Common Terms and Conditions Issues</h2>
        <p  class="s-intro"></p>
    ...
    <section class="s-grey">
      <div class="container asym-layout">
        <div class="asym-minor">
          ...
          <h2 class="s-heading">What Causes Terms and Conditions Failures?</h2>
        ...
        <div class="asym-major">
          <img src="/terms-and-conditions-data-recovery-service.webp" alt="Terms and Conditions service Glendale CA" class="rounded-img" />
    ...
    <section class="s-grey">
      <div class="container dual-col">
        <div class="dual-box">
          ...
          <h3 class="dual-heading">Why Terms and Conditions Devices Are Prone to Issues</h3>
    ...
    <!-- MID-PAGE FORM -->
    <section class="mid-form-section" style="background: linear-gradient(to right, rgba(50,52,58,0.92) 0%, rgba(50,52,58,0.72) 50%, rgba(30,32,38,0.2) 100%), url('/terms-and-conditions-data-recovery-service.webp') right center / cover no-repeat;">
      <div class="container mid-form-inner">
        <div class="mid-form-text">
          <div class="section-label light">Get Started</div>
          <h2 class="dark-heading">Need Help With Your Terms and Conditions?</h2>
            ...
            <div class="mf-row">
              ...
              <div class="mf-group">
                ...
                <div class="mf-radio-group">
                  <label class="mf-radio"><input type="radio" name="contactTermsan" value="call" checked /> CALL</label>
                  <label class="mf-radio"><input type="radio" name="contactTermsan" value="email" /> EMAIL</label>
                  <label class="mf-radio"><input type="radio" name="contactTermsan" value="text" /> TEXT</label>
                </div>
              </div>
            </div>
    ...
    <section class="s-contact-band">
      <div class="container">
        <div class="contact-banner-card">
          <h2 class="contact-banner-heading">Contact Us for Terms and Conditions</h2>
        </div>
