...
const faqs = [
  { q: '1. Do you offer payment plans for data recovery services?', a: 'Yes, we offer in-house, interest-free payment plans for customers who need help managing the cost of data recovery. These plans are designed to make our services more accessible while still maintaining our high recovery standards. Please note, recovered data will only be released once the full balance is paid in full .' },
  { q: '2. Who qualifies for a data recovery payment plan?', a: 'Our interest-free payment plans are available to all customers—no credit check required. To get started, we simply require 25% of the total recovery cost upfront, with the remaining balance paid over time. This flexible option helps make professional data recovery more accessible when you need it most.' },
  { q: '3. How do I apply for a payment plan?', a: 'Our payment plans are handled in-store only —no online application or credit check is required. During your visit, our team will walk you through the simple process. Once you make the 25% upfront payment, we’ll get started on your recovery and provide a clear payment schedule for the remaining balance.' },
  { q: '4. Is there a minimum or maximum amount for a payment plan?', a: 'Yes, payment plans are available for recovery cases starting at $300 and up . There’s no strict maximum, and we’re happy to work with you on larger recoveries as long as the 25% upfront requirement is met. If you’re unsure whether your case qualifies, feel free to contact us or visit our store for a free consultation.' },
  { q: '5. Will applying for a payment plan affect my credit score?', a: 'No — we do not perform any credit checks for our in-house payment plans. Approval is guaranteed as long as the minimum upfront payment is made, and your credit score is never impacted.' },
  { q: '6. What types of devices are eligible for payment plan options?', a: 'Payment plans are available for all major recovery types, including hard drives , SSDs , RAID systems , USB drives , SD cards , and mobile phones . Whether your case is logical, physical, or complex, our payment plan options can help make recovery more accessible.' },
  { q: '7. Can I still qualify for a payment plan if I live outside California?', a: 'Yes! Our payment plan options are available nationwide , and so is our data recovery service. We offer free shipping across the U.S., making it easy for anyone to get started, no matter their location.' },
  { q: '8. When do I start making payments?', a: 'In most cases, payments begin after the recovery is complete and you’ve approved the results. You’ll receive a breakdown of your payment schedule based on your selected plan.' }
]
  ...
  <div>
    ...
    <section class="section-bg-3 section-pad">
      <div class="container">
        <div class="section-header">
          <h2 class="section-title">Do you offer Payment Plans for Data Recovery?</h2>
        </div>
    ...
    <section class="cta-band section-bg-2">
      <div class="container cta-band-inner">
        <div>
          <h2 class="cta-title">Need Help With Data Recovery Payment Plan?</h2>
