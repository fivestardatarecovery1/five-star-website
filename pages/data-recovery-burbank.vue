...
useSeoMeta({
  title: 'Data Recovery Burbank CA — Five Star Data Recovery',
...
const causesOutro = ''
const causes = [
  'A photographer near Magnolia Blvd lost 5 years of Lightroom catalogs from an external Seagate drive — 100% recovered.',
  'A post‑production company’s RAID 5 failed mid‑project. We cloned all drives and rebuilt their file system in under 3 days.',
  'A local home user had a dead WD Blue hard drive from an old desktop — all family photos retrieved.',
]

const processIntro = 'We use a systematic, proven approach for every Data Recovery Burbank CA case.'
const steps = [
...
const driveTypes = [
  'Clicking or non-powering hard drives (HDDs)',
  'Solid State Drives (SSDs) with no response',
  'Water-damaged or dead iPhones',
  'Failed RAID 0, 1, 5, 6, or 10 arrays',
  'USB flash drives & SD cards from DSLRs or video equipment',
  'Encrypted drives and BitLocker devices',
]
...
const d3Texts = [
  'Data Recovery Burbank CA devices can fail due to a variety of causes including physical damage, firmware corruption, electrical issues, and normal wear over time.',
...
const midBody = [
  'While our main lab is not physically located in Burbank, we proudly serve the Burbank area and offer free same-day pickup for local residents and businesses. Our close proximity allows us to provide fast, convenient, and professional service throughout the region.',
  'Most data recovery cases are completed in 3–5 business days, depending on the issue. Whether you choose to drop off, mail in, or schedule a free pickup in Burbank, you will always receive a status update the same day your device arrives. Our goal is to keep you informed every step of the way while working efficiently to recover your data.',
  'We recover data from hard drives, SSDs, USB flash drives, iPhones, RAID setups, SD cards, and more. If you’ve experienced data loss in Burbank, we can help.',
]

const contactText = 'If you\'re experiencing issues with your Data Recovery Burbank CA, don\'t wait. Acting early gives you the best chance of recovering your data safely and completely.'
const contactList = [
  ...
  <div class="page-content">
    ...
    <section class="s-white">
      <div class="container">
        ...
        <h2 class="s-heading">Common Data Recovery Burbank CA Issues</h2>
        <p  class="s-intro"></p>
    ...
    <section class="s-grey">
      <div class="container asym-layout">
        <div class="asym-minor">
          ...
          <h2 class="s-heading">What Causes Data Recovery Burbank CA Failures?</h2>
        ...
        <div class="asym-major">
          <img src="/data-recovery-burbank-ca.jpg" alt="Data Recovery Burbank CA service Glendale CA" class="rounded-img" />
    ...
    <section class="s-grey">
      <div class="container dual-col">
        <div class="dual-box">
          ...
          <h3 class="dual-heading">Why Data Recovery Burbank CA Devices Are Prone to Issues</h3>
    ...
    <!-- MID-PAGE FORM -->
    <section class="mid-form-section" style="background: linear-gradient(to right, rgba(50,52,58,0.92) 0%, rgba(50,52,58,0.72) 50%, rgba(30,32,38,0.2) 100%), url('/data-recovery-burbank-ca.jpg') right center / cover no-repeat;">
      <div class="container mid-form-inner">
        <div class="mid-form-text">
          <div class="section-label light">Get Started</div>
          <h2 class="dark-heading">Need Help With Your Data Recovery Burbank CA?</h2>
    ...
    <section class="s-contact-band">
      <div class="container">
        <div class="contact-banner-card">
          <h2 class="contact-banner-heading">Contact Us for Data Recovery Burbank CA</h2>
        </div>
