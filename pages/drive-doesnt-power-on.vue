...
useSeoMeta({
  title: 'Hard Drive No Power — Data Recovery — Five Star Data Recovery',
  description: 'Hard drive won\'t power on? Five Star Data Recovery recovers data from drives that don\'t spin up.'
})

const list1 = [
  'The drive is not spinning or making any noise',
  'Your computer doesn\'t detect the drive',
  'No LED lights turn on (for external drives)',
  'You don’t hear the usual clicking or humming sounds',
]
const list2 = [
...
const list3 = [
  ...
  'Swap circuit boards between different drives',
  'Plug and unplug the drive repeatedly',
  'Use DIY software—these tools won’t help if the drive is not spinning',
  'Check your cables and power source',
  'Try the drive on another computer or enclosure',
  'Bring it to a professional recovery lab if the issue continues',
]
const list4 = [
  ...
  <div class="page-wrapper">
    ...
    <section class="hero-section">
      <div class="container hero-inner">
        <div class="hero-text">
          <h1 class="hero-title">Hard Drive No Power?</h1>
          <p class="hero-sub">Get Your Data Back In No Time.</p>
          <p class="hero-desc">If your hard drive isn\'t turning on, you\'re not alone. Many people run into this problem and worry their data is gone forever. A drive that won\'t spin up can still have its data fully intact — and our engineers can often recover it.</p>
    ...
    <section class="light-alt-section">
      <div class="container">
        <h2 class="section-heading">What Are the Signs of a No Power Issue?</h2>
        <p class="body-text">A hard drive with no power will usually show some or all of these signs:</p>
        <p class="body-text">In these cases, the drive is likely not receiving electricity. This could be from a failed circuit board, damaged cable, or even a shorted power supply.</p>
        <ul class="cause-list">
    ...
    <section class="light-section">
      <div class="container">
        <h2 class="section-heading">Common Reasons Why a Hard Drive Doesn’t Power On</h2>
        <p class="body-text">Several problems can cause your Hard Drive to not power on:</p>
        <ul class="drive-list">
    ...
    <section class="light-alt-section">
      <div class="container">
        <h2 class="section-heading">What You Should (and Shouldn’t) Do</h2>
        <p class="body-text">If your hard drive doesn’t power on, the most important thing is to avoid doing anything that could make the situation worse.</p>
        <p class="body-text">A drive that doesn’t spin can still hold your files. We have tools and cleanroom environments that allow us to fix hard drives and safely extract data without causing additional damage.</p>
        <ul class="drive-list">
    ...
    <section class="light-section">
      <div class="container">
        <h2 class="section-heading">Our Hard Drive Recovery Process</h2>
        <p class="body-text">At Five Star Data Recovery, we follow a step-by-step method to recover data from drives with no power:</p>
        <p class="body-text">If your Hard Drive has No Power, we will first determine if the issue is external (cable or enclosure) or internal (board or heads). If needed, we can replace damaged parts using donor drives matched to your specific model.</p>
        <ul class="drive-list">
    ...
    <section class="light-alt-section">
      <div class="container">
        <h2 class="section-heading">Data Recovery Process</h2>
        <p class="body-text">Our data recovery process is built around security, transparency, and peace of mind. From start to finish, we keep you informed with clear updates at every stage. With a commitment to honest service and no hidden fees, we follow through on every promise — ensuring a smooth and stress-free experience.</p>
      </div>
    </section>
    <section class="light-alt-section">
      <div class="container">
        <h2 class="section-heading">Receive a Free Diagnosis</h2>
        <p class="body-text">Our team will evaluate your device and provide a detailed diagnosis along with an initial quote — completely free of charge and with no obligation to proceed.</p>
      </div>
    </section>
    ...
    <section class="contact-band">
      <div class="container contact-band-inner">
        <div class="contact-band-text">
          <h2 class="contact-band-title">Contact Us — Hard Drive No Power</h2>
          <p class="contact-band-sub">A drive that won\'t power on doesn\'t mean your data is gone. Contact us for a free evaluation.</p>
