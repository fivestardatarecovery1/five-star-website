import { _ as __nuxt_component_0 } from './nuxt-link-B7llGaxe.mjs';
import { defineComponent, useSlots, toRefs, computed, toRef, isRef, h, useSSRContext } from 'vue';
import { h as hash } from '../_/index.mjs';
import { a as useContentDisabled, u as useAsyncData, q as queryContent, w as withContentBase, e as encodeQueryParams, b as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-D9_zEv08.mjs';
import { a as useContentPreview } from './preview-CfDwRO4t.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-BvYjiXqt.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-JEwx5c0S.mjs.map
