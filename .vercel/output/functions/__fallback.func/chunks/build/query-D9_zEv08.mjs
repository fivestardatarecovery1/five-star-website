...
import { a as useNuxtApp, f as asyncDataDefaults, b as useRuntimeConfig, g as createError } from './server.mjs';
import { w as withLeadingSlash, j as joinURL, q as withoutTrailingSlash, K as withBase } from '../nitro/nitro.mjs';
import { h as hash } from '../_/index.mjs';
import { u as useRequestEvent, a as useContentPreview } from './preview-CfDwRO4t.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-BvYjiXqt.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-D9_zEv08.mjs.map
